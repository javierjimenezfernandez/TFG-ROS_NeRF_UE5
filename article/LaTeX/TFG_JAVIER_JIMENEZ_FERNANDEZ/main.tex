...
Se consigue el control del robot real mediante el uso de la herramienta \gls{rosintegration} para \arcshort{ue} en conjunto con \gls{rosbridge} para la conexión con la máquina virtual donde se alojan los nodos de \acrshort{ros}. 
